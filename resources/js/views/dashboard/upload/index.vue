  ...
  <div>
    <Layout>
      <div class="divide-y divide-gray-200 lg:col-span-9">
        <BasicTransition>
          <form v-if="$file.config.form" class="divide-y divide-gray-200 lg:col-span-9">
              <!-- Profile section -->
              <div class="py-6 px-4 sm:p-6 lg:pb-8 bg-white sm:rounded-xl shadow mb-2">
                <div>
                  <h2 class="text-lg font-medium leading-6 text-gray-900">Upload Soft-Copy CSC ID</h2>
                </div>
                ...
                <div class="flex-none sm:flex justify-end mt-8 gap-1">
                  <AppButton @click="$file.ChangeForm(null, '')" color='white' class="mr-1 w-full sm:w-auto mb-2 sm:mb-0">Cancel</AppButton>
                  <AppButton type="submit" color='white' class="mr-1 w-full sm:w-auto mb-2 sm:mb-0">Upload</AppButton>
                </div>
              </div>
            </form>
        </BasicTransition>
...
import { UserCircleIcon, MapPinIcon, MapIcon, DevicePhoneMobileIcon, EnvelopeIcon } from '@heroicons/vue/20/solid'
