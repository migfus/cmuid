  ...
  <NotificationGroup group="error">
    <div class="fixed inset-0 flex items-start justify-end p-6 px-4 py-6 pointer-events-none z-50">
      <div class="w-full max-w-sm">
        ...
        >
          <div
            v-for="row, idx in notifications"
            :key="row.id"
            class="flex w-full max-w-sm mx-auto mt-4 overflow-hidden bg-white/80 backdrop-blur-lg rounded-lg shadow-md"
          >
              ...
              <div class="p-4">
                <div class="flex items-start">
                  ...
                  <div class="ml-3 w-0 flex-1 pt-0.5">
                    ...
                    <p class="mt-1 text-sm text-gray-500" v-html='row.text'></p>
                  </div>
                  <div class="ml-4 flex flex-shrink-0">
                    <button @click="close(row.id)" type="button" class="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2">
