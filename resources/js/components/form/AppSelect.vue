<template>
    ...
    <Field
        ...
        :name="$props.name"
        :class="[
            'mt-1 block w-full rounded-xl border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-primary-500 sm:text-sm',
